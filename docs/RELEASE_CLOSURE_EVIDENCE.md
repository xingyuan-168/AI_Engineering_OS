...
<!-- codex-os-document: {"schema_version":"1.2","document_version":"0.3.0","status":"approved","owner":"release-manager","requirement_refs":["REQ-1.6.2","RELEASE-001","GATE-001","EXEC-001"]} -->
