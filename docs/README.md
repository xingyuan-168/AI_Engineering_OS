...
<!-- codex-os-document: {"schema_version":"1.2","document_version":"0.3.0","status":"review-ready","owner":"product-manager","requirement_refs":["REQ-1.6.2","DOC-001"]} -->
...
| `proposals/` | 治理整改提案原文；可执行决策转入 ADR 后仅作输入留档 | 新提案进入或决策转入 ADR 时 |
